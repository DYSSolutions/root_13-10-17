...
*/
		update_company_prefs(
			get_post( array('coy_name','coy_no','gst_no','tax_prd','tax_last',
				...
				'bcc_email', 'alternative_tax_include_on_docs', 'suppress_tax_rates',
				'use_fixed_assets','logo_h','logo_w','date'/*,'bank_details','bank_account'*/))
...
text_row_ex(_("Backdate Entries Allowed:"), 'date', 10, 10, 'Blank = Disable, 0 = Yesterday Disallowed, 1 = Day Before Yesterday Disallowed', $_POST['date'], null, _('Days Entry.'));
