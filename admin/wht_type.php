...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM')
{
	...
	if ($input_error != 1)
	{
		if ($selected_id != -1)
		{
			update_wht_type($selected_id, $_POST['description'], input_num('tax_percent'), $_POST['co_account'],$_POST['wth_tax_category'],$_POST['co_account_supplier']);
			$note = _('Selected wht type has been updated');
		}
		else
		{
			add_wht_type($_POST['description'], input_num('tax_percent'), $_POST['co_account'],
				$_POST['parent_id'],$_POST['wth_tax_category'],$_POST['co_account_supplier']);
...
<center>
	...
	<td><a class="hvr-float-shadow" href="#"><i class="fa fa-text-width" style="margin-right: 5px; font-size: large;"></i> WHT GL</a></td>
...
$th = array(/*_("ID"),*/ _("WHT Type"), _("Head"),_("%"), _("A/C Sales"), _("A/C Supplier"), _("WHT Tax Type "), "");
